# current-runtime-extensions Specification

## Purpose

Classify reviewed optional runtime differences precisely while requiring compatible common request semantics and verified native core behavior.
