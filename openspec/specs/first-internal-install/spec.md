# first-internal-install Specification

## Purpose

Install the first internal CLI safely when no profile or target exists, without replacing partial or concurrent state or claiming Desktop readiness.
