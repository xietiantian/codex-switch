# standalone-runtime-update Specification

## Purpose

Preserve complete standalone runtime packages during staged CLI updates while retaining stable command paths, integrity checks, and rollback behavior.
