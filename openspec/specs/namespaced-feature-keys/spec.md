# namespaced-feature-keys Specification

## Purpose

Accept valid namespaced feature identifiers consistently without weakening malformed-output checks or compatibility classification.
