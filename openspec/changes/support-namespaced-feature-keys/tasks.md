## 1. Grammar repair
- [x] 1.1 Reproduce the dotted-row failure through public inventory collection.
- [x] 1.2 Share the bounded grammar across parsing and feature identity validation.
- [x] 1.3 Verify canonical identity, policy evidence and retained invalid/drift failures.
